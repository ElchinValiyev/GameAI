...
1. keep data structure with counters for each possible move;
2.for 10000 (or any large number) times:
3. 	 play_game;
4. 	 update counters of winner's moves;
5. normalize all counters in data structure -> obtain moves' probabilities;
6. write probabilities to file.
\end{lstlisting}
}
