...
if __name__ == '__main__':
    ...
    state_centers_num = input("Enter number of som centers (reasonable: from 15 to 70-80, max 1300): ")
    activity_centers_num = input("Enter number of activity centers (reasonable: from 15 to 70-80, max 1300): ")
    ...
    if (os.path.isfile(som_centers_filename) == False):
        print "Learning started"
        som.learn_som(points_filename, state_centers_num, som_iterations_num)
